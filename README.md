...
- __***Additional search capabilities__*** : In future I would like to impliment the ability to search by entering a certain word the search input.

- __***Photo upload__*** : In fiture i would like to give the user the ability to upload a photo file locally as opposed to a photo-url.
